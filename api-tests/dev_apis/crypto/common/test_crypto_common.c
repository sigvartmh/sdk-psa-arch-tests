...
/* Zigbee install code 83FED3407A939723A5C639B26916D505 followed by its CRC,
 * C3B5. The AES-MMO hash of the two together is the link key below, which is the
 * example given in the Zigbee specification.
 */
